...
export function AuthScreen() {
    ...
    useEffect(() => {
        if (isAuthenticated && user !== null) {
            navigate(user.otpVerified ? '/home' : '/verify-otp');
        }
                                    ...
                                    {mode === 'register' && (
                                        <div style={{display: 'flex', gap: '14px', position: 'relative'}}
                                            ...
                                            <FormField
                                                ...
                                                type="text"
                                                style={window.innerWidth < 640 ? {width: '100%'} : {width: '50%'}}
                                            />
                                            <FormField
                                                icon={<User size={15} color="#9CA3AF"/>}
                                                placeholder="Nom"
...
function FormField({icon, placeholder, value, onChange, type, rightAction, style}: FormFieldProps) {
